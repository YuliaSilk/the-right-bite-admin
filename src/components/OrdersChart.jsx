    ...
    <div className="bg-white p-6 rounded-xl shadow-md">
      ...
      <ResponsiveContainer width="100%" height={350}>
        ...
        >
          ...
          <YAxis yAxisId="left" dataKey="count" axisLine={false} tickLine={false} tick={{ fill: '#666', fontSize: 12 }} />
          <YAxis
            yAxisId="right"
            orientation="right"
            dataKey="avgCheck"
          ...
          />
          <Bar yAxisId="left" dataKey="count" name="Orders Count" fill="#2c6e49" radius={[8, 8, 0, 0]} maxBarSize={40} />
          <Bar yAxisId="right" dataKey="avgCheck" name="Average Check" fill="#FFA726" radius={[8, 8, 0, 0]} maxBarSize={40} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
